...
cat vendor_bootimg/11_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb.* 2>/dev/null >> vendor_bootimg/11_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb
rm -f vendor_bootimg/11_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb.* 2>/dev/null
